<?php
  ob_start();
  //set title
  echo "<script>setTimeout(function(){var tts = document.getElementsByTagName(\"title\");if(tts.length > 0)tts[0].innerHTML=\"Update Doctor Record\"; else {var tt0 = document.createElement(\"TITLE\"); tt0.innerHTML = \"My title\"; document.head.appendChild(tt0);}}, 200);</script>";
  ...
  $updateDoctorRecord = $outpatient->updateDoctorRecord();
    ...
    <div class="col-sm-10 mx-auto">
      ...
      <form method="post" >    
        <div class="row">
          <div  class="col-sm-4">
            <?php echo 'LastName'; ?>
            <input type="text" required class="form-control  <?php echo (!empty($d_lname)) ? 'is-invalid' : ''; ?>"  name="d_lname" placeholder="Lastname" value="<?= $getDoctorRecords['d_lname'];?>">
            <div class="text-danger text-center"><!-- <//?php echo form_error('lname'); ?> --></div>
          </div>
          <div class="col-sm-4">
            <?php echo 'Firstname'; ?>
            <input type="text" required style="margin-left: 4px;" class="form-control <?php echo (!empty($d_fname)) ? 'is-invalid' : ''; ?>" name="d_fname" placeholder="Firstname" value="<?= $getDoctorRecords['d_fname'];?>">
            <div class="text-danger text-center"><!-- <//?php echo form_error('fname'); ?> --></div>
          </div>
          <div class="col-sm-3">
            <?php echo 'Middlename'; ?>
            <input type="text" style="margin-left: 2px;"
              class="form-control  <?php echo (!empty($d_mname)) ? 'is-invalid' : ''; ?>" name="d_mname" placeholder="Middlename" value="<?= $getDoctorRecords['d_mname'];?>">
        ...
        <div class="row">
          <div class="col-sm-11">
            <?php echo 'Address'; ?>
            <input type="textarea" required class="form-control <?php echo (!empty($address)) ? 'is-invalid' : ''; ?>" name="d_address" placeholder="Permanent Address" value="<?= $getDoctorRecords['d_address'];?>">
        ...
        <div class="row">
          <div class="col-sm-3">
            <?php echo 'Age'; ?>
            <input type="text" class="form-control <?php echo (!empty($d_age)) ? 'is-invalid' : ''; ?>" name="d_age" placeholder="Age" value="<?= $getDoctorRecords['d_age'];?>">
          ...
          <div class="col-sm-3">
            ...
            <select class="form-control" name="d_gender">
              <option value="<?= $getDoctorRecords['d_gen'];?>"><?= $getDoctorRecords['d_gen'];?></option>
          ...
          <div class="col-sm-5">
            ...
            <input type="number" class="form-control <?php echo (!empty($d_num)) ? 'is-invalid' : ''; ?>"
              placeholder="Mobile/Tel No." name="d_num" value="<?= $getDoctorRecords['d_number'];?>">
        ...
        <div class="row">  
          ...
          <div class="col-sm-3">
            <?php echo 'Fields'; ?>
              <select required class="form-control"  value="<?= $getDoctorRecords['d_field'];?>" name="d_fields">
                <option><?= $getDoctorRecords['d_field'];?></option>
          ...
          <div class="col-sm-3">
            <?php echo 'Ward'; ?>
            <select required class="form-control" value="<?= $getDoctorRecords['d_ward'];?>" name="d_wards">
              <option><?= $getDoctorRecords['d_ward'];?></option>
         ...
         <br><br>
          <div >
            ...
            <button type="submit" class="btn btn-success btn-icon-split" name="updateDoctorRecord">
