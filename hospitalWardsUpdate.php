<?php
  ...
  $getWardsRecords = $outpatient->getWardsRecord();
  $updateWardsRecords = $outpatient->updateWardsRecord();
        ...
        <div class="card-body">
          <form method="post">
            <div class="form-group">
              ...
              <div class="col-sm-12">
                <input type="text" class="form-control" name="w_name" value="<?= $getWardsRecords['w_name']?>"$>
              </div>
            </div>
            <div class="form-group">
              <label for="inputPassword" class="col-sm-6 col-form-label">Description: </label>
              <div class="col-sm-12">
                <textarea class="form-control" rows="3" name="w_description"><?= $getWardsRecords['w_description']?></textarea>
              </div>
            </div>
            <a href="hospitalWards.php" style="margin-left:13px;" type="button" class="btn btn-secondary"><i class="fas fa-arrow-left"></i> Back</a>
