						...
						<?php foreach($doctorRecords as $record): $counter += 1;?>
							<tr>
								...
								<td width="13%" class='text-center'>
									<a href="doctorRecordsView.php?pr_id=<?=$record['d_id'];?>" class="mr-4" title="View Record" data-toggle="tooltip">
										<i class="fa fa-eye"></i></a>
									<a href="doctorRecordsUpdate.php?pr_id=<?=$record['d_id'];?>" class="mr-4" title="Update Record" data-toggle="tooltip">
									...
									<div class="modal fade" id="delPatientRecordModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
										...
										<div class="modal-content">
											...
											<div class="modal-body">
												<p id="delStatement" >Delete statement</p>
...
$("#del a").on("click", function() {
	...
	document.getElementById("delStatement").innerHTML = "Are you sure you want to delete Case No. "  + dataId + "?";
